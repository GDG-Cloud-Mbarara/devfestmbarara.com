      ...
      <v-row>
        <v-col md="12" lg="12" class="d-block d-sm-block d-md-none px-0">
          ...
          <p class="my-0 mb-8 h1-subheading google-font">
            Now that you are here, how about personalising your DevFest Mbarara
            2024 profile? Upload an image and generate a personalised badge with
            the DevFest Mbarara 2024 frame. Also share your image using
            #DevFestMbarara on different social platforms.
          </p>
        </v-col>
      </v-row>
      <!-- Mobile -->
